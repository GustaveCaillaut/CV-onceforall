...
def train_one_epoch(
    ...
    for step, (images, targets) in enumerate(loader):
        ...
        # Teacher is only used after largest-network training. It is the current
        # largest subnet, not a separate model.
        use_kd = kd_ratio > 0 and stage != "largest"
        teacher_logits = get_teacher_logits(model, images) if use_kd else None
...
def cmd_train_supernet(args: argparse.Namespace) -> None:
    ...
    # Optional final test of largest subnet.
    model.set_largest_subnet()
